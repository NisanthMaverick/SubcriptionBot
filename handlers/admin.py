...
def get_admin_handlers() -> list:
    ...
    return [
        ...
        CallbackQueryHandler(handle_menu_navigation, pattern="^(menu_main|menu_admin_settings|menu_plans|menu_payment|menu_subs|menu_config|menu_status|menu_db_mgr|menu_db_clean|menu_db_sync|db_sync_|set_db_interval_|close_panel|list_|reset_upi_ids|db_warn_|db_exec_|del_plan_|welcome_|ep_resext_|chan_menu|raid_menu|menu_backup_restore|menu_admin_access|get_link_config_menu|toggle_link_delivery_type|toggle_restrict_link_sharing|toggle_link_auto_delete|set_link_exp_|link_timer_config_menu|menu_pay_methods)"),
